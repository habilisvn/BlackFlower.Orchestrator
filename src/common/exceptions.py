class MissingParameterException(Exception):
    def __init__(self, *, valid_params: list[str], message: str = None):
        ...
        if message is None:
            message = f"Missing required parameter. Please provide at least one of the following: {', '.join(valid_params)}"
